...
public class AstaribassoModel {
    ...
    public AstaribassoModel() {
    }

    // Costruttore con tutti i campi
    public AstaribassoModel(boolean stato, String titolo, String categoria, String sottocategoria, String descrizioneprodotto, String venditore, String immagineprodotto, int importodecremento, int prezzominimosegreto, int prezzoiniziale, Integer timerdecremento, int ultimoprezzo) {
        this.stato = stato;
        this.titolo = titolo;
