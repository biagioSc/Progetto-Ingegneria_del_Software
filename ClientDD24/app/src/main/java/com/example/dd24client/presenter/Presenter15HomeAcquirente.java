...
import com.example.dd24client.views.Activity15HomeAcquirenteView;
...
public class Presenter15HomeAcquirente {
    private final Activity15HomeAcquirenteView view;
    private final ApiService apiService;

    public Presenter15HomeAcquirente(Activity15HomeAcquirenteView view, ApiService apiService){
        this.view = view;
