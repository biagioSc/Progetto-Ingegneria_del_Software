...
public class Presenter26ProfiloVenditoreNegozio {
    private Activity26ProfiloVenditoreNegozioView view;
    private ApiService apiService;

    public Presenter26ProfiloVenditoreNegozio(Activity26ProfiloVenditoreNegozioView view, ApiService apiService){
        this.view = view;
