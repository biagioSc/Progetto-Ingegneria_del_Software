...
public class Presenter44Search {
    private Activity44SearchView view;
    private ApiService apiService;

    public Presenter44Search(Activity44SearchView view, ApiService apiService){
        this.view = view;
        this.apiService = apiService;
    }

    public void asteRibassoAcquirente(String query, List<String> categoria, String ordinaper, Float startvalue, Float endvalue, String email) {
        Call<MessageResponseRibasso> call = apiService.richiediAstaRibassoSearchAcquirente(query, categoria, ordinaper, startvalue, endvalue, email);
    ...
    public void astaSilenziosaAcquirente(String query, String data, List<String> categoria, String ordinaper, String email) {
        Call<MessageResponseSilenziosa> call = apiService.richiediAstaSilenziosaSearchAcquirente(query, data, categoria, ordinaper, email);
