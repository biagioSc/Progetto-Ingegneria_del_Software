...
public class presenter33SeguitePresenter {
    private final activity33SeguiteView view;
    private final ApiService apiService;

    public presenter33SeguitePresenter(activity33SeguiteView view, ApiService apiService) {
        this.view = view;
