...
public class Activity07Signup extends AppCompatActivity {
    ...
    private ImageView fotoImageView, inserisciFoto, indietroImageView, check1, check2, check3, check4, check5;
    private TextView continuaButton, textViewError;
    private String nome="", cognome="", nazionalita="", citta="", biografia="", socialLinks="", linkWeb="", email="", password="", confermaPassword="", imageConvertToSave="", uriImageString="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseAnalytics.getInstance(this).setCurrentScreen(this, "Activity07Signup", null);
    ...
    private void setListener() {
        ...
        indietroImageView.setOnClickListener(v -> {
            String messageString = "Cliccato 'indietro' in 07signup";
    ...
    private void setExtraParameters(){
        ...
        uriImageString = intentRicevuto.getStringExtra(fotoStringa);
    ...
    private void continuaFunction(){
        String messageString = "Cliccato 'continua' in 07signup";
        String logging = "[USABILITA' UTENTE]";
        Log.d(logging, messageString);
        ...
        if(continua){
            Intent intent = new Intent(Activity07Signup.this, Activity08Signup.class);
            intent.putExtra(nomeStringa, nomeEditText.getText().toString());
            intent.putExtra(cognomeStringa, cognomeEditText.getText().toString());
            intent.putExtra(nazionalitaStringa, nazionalitaSpinner.getText().toString());
            intent.putExtra(cittaStringa, cittaSpinner.getText().toString());
