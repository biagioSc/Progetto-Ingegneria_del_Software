...
public class Activity24DettaglioAstaRibassoChiusa extends AppCompatActivity implements Activity24DettaglioAstaRibassoChiusaView {
    private UtilsFunction function;
    private ImageView indietroImageView, image_product;
    private TextView nomeProdottoTextView, nomeVenditoreTextView, categoriaTextView, sottocategoriaTextView, testoDescrizioneTextView, infoprezzo;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_24_dettaglio_asta_ribasso_chiusa);
        FirebaseAnalytics.getInstance(this).setCurrentScreen(this, "Activity24DettaglioRibassoChiusa", null);
    ...
    protected void onResume() {
        ...
        if (activityStarted) {
            ...
            presenter.datiUtente24(emailvenditore);
            presenter.seguitaboolAsta24(id, email);
        }
    ...
    private void setListener() {
        ...
        indietroImageView.setOnClickListener(v -> {
            String messageString = "Cliccato 'indietro' in 24dettaglio";
        ...
        nomeVenditoreTextView.setOnClickListener(v->{
            String messageString = "Cliccato 'nome venditore' in 24dettaglio";
            String logging = "[USABILITA' UTENTE]";
            Log.d(logging, messageString);

            Intent intent = new Intent(Activity24DettaglioAstaRibassoChiusa.this, Activity25ProfiloVenditoreInformazioni.class);
    ...
    private void seguiFunction(int id, String email) {
        String messageString = "Cliccato 'segui/seguita' in 24dettaglio";
        String logging = "[USABILITA' UTENTE]";
        Log.d(logging, messageString);

        seguiAstaToggleButton.setClickable(false);
        presenter.seguiAsta24(id, email);
    }
    ...
    public void utenteNonTrovato(MessageResponse errore_password) {
        ...
        Toast.makeText(Activity24DettaglioAstaRibassoChiusa.this, "Informazioni venditore non disponibili", Toast.LENGTH_SHORT).show();
    }
