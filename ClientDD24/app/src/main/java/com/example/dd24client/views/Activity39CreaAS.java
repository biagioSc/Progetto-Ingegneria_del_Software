...
import com.example.dd24client.presenter.Presenter39CreaAstaSilenziosa;
...
public class Activity39CreaAS extends AppCompatActivity implements Activity39CreaASView {
    ...
    private String imageConvertToSave, email="";
    ...
    private Presenter39CreaAstaSilenziosa createPresenter;
    ApiService apiService = RetrofitClient.getRetrofitInstance().create(ApiService.class);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_39_creaas); // Sostituisci con il tuo file layout
    ...
    private void setComponents() {
        ...
        createPresenter = new Presenter39CreaAstaSilenziosa(this, apiService);
    ...
    private void continuaFunction(){
        String messageString = "Cliccato 'continua' in 39crea";
    ...
    public void showPopupMessage() {
        runOnUiThread(() -> {
            LayoutInflater inflater = LayoutInflater.from(Activity39CreaAS.this);
            ...
            android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(Activity39CreaAS.this);
            ...
            if (!isFinishing() && dialog != null && !dialog.isShowing()) {
                ...
                btnConferma.setOnClickListener(v -> {
                    ...
                    createPresenter.creaAstasilenziosa1(asta);
    ...
    public void showPopupMessageIndietro() {
        String messageString = "Cliccato 'indietro' in 39crea";
        String logging = "[USABILITA' UTENTE]";
        Log.d(logging, messageString);
    ...
    public void onCreateSuccess(MessageResponse body) {
        ...
        bundle.putString(FirebaseAnalytics.Param.ITEM_ID, "39");
        bundle.putString(FirebaseAnalytics.Param.ITEM_NAME, "crea asta silenziosa");
        mFirebaseAnalytics.logEvent(FirebaseAnalytics.Event.SELECT_CONTENT, bundle);

        Toast.makeText(Activity39CreaAS.this, body.getMessage(), Toast.LENGTH_SHORT).show();
        overridePendingTransition(0, 0);
        finish();
    }
    ...
    public void onCreateFailure(MessageResponse errore_di_registrazione) {
        Toast.makeText(Activity39CreaAS.this, errore_di_registrazione.getMessage(),
