...
public class Activity43DettaglioASChiusa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseAnalytics.getInstance(this).setCurrentScreen(this, "Activity43DettaglioASChiusa", null);
    ...
    private void setListener() {
        ...
        indietroImageView.setOnClickListener(v -> {
            String messageString = "Cliccato 'indietro' in 43dettaglio";
