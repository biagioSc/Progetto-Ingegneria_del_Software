...
public class Activity48VendiAS extends AppCompatActivity implements Activity48VendiASView {
        ...
        tipologiaSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                if (selectedItem.equals("Al Ribasso")) {
                    ...
                    Intent intent = new Intent(Activity48VendiAS.this, Activity47VendiAR.class);
                    startActivity(intent);
                    overridePendingTransition(0, 0);
                    finish();
                } else if (selectedItem.equals("Tipologia")) {
                    // Apre l'activity Dashboard
                    Intent intent = new Intent(Activity48VendiAS.this, Activity46Vendi.class);
                    startActivity(intent);
                    overridePendingTransition(0, 0);
                    finish();
                }
    ...
    public void showPopupMessage() {
        runOnUiThread(() -> {
            LayoutInflater inflater = LayoutInflater.from(Activity48VendiAS.this);
            ...
            android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(Activity48VendiAS.this);
    ...
    public void onCreateSuccess(MessageResponse body) {
        ...
        bundle.putString(FirebaseAnalytics.Param.ITEM_ID, "48");
        bundle.putString(FirebaseAnalytics.Param.ITEM_NAME, "crea asta ribasso");
        mFirebaseAnalytics.logEvent(FirebaseAnalytics.Event.SELECT_CONTENT, bundle);

        Toast.makeText(Activity48VendiAS.this, body.getMessage(), Toast.LENGTH_SHORT).show();
        overridePendingTransition(0, 0);
        finish();
    }
    ...
    public void onCreateFailure(MessageResponse errore_di_registrazione) {
        Toast.makeText(Activity48VendiAS.this, errore_di_registrazione.getMessage(),
